...
namespace EventIntern
{
    ...
    public:
        ...
        virtual bool IsBindedToSameFunctionAs(EventHandlerImpl<Args...>* pHandler2)
        {
            ...
            EventHandlerImplForNonMemberFunction<Args...>* pHandlerCasted = dynamic_cast<
                EventHandlerImplForNonMemberFunction<Args...>*>(pHandler2);
            if (!pHandlerCasted)
                return false;
    ...
    public:
        ...
        virtual bool IsBindedToSameFunctionAs(EventHandlerImpl<Args...>* pHandler2)
        {
            ...
            EventHandlerImplForMemberFunction<U, Args...>* pHandlerCasted = dynamic_cast<
                EventHandlerImplForMemberFunction<U, Args...>*>(pHandler2);
            if (!pHandlerCasted)
                return false;

            return this->m_pCallerInstance == pHandlerCasted->m_pCallerInstance && this->m_pMemberFunction ==
                pHandlerCasted->m_pMemberFunction;
        }
    ...
    public:
        ...
        virtual bool IsBindedToSameFunctionAs(EventHandlerImpl<void>* pHandler2)
        {
            ...
            EventHandlerImplForNonMemberFunction<void>* pHandlerCasted = dynamic_cast<
                EventHandlerImplForNonMemberFunction<void>*>(pHandler2);
            if (!pHandlerCasted)
                return false;
    ...
    public:
        ...
        virtual bool IsBindedToSameFunctionAs(EventHandlerImpl<void>* pHandler2)
        {
            ...
            EventHandlerImplForMemberFunction<U, void>* pHandlerCasted = dynamic_cast<EventHandlerImplForMemberFunction<
                U, void>*>(pHandler2);
            if (!pHandlerCasted)
                return false;
